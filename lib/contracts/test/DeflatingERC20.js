...
exports.DeflatingERC20 = void 0;
const eth_wallet_1 = require("@ijstech/eth-wallet");
const DeflatingERC20_json_1 = __importDefault(require("./DeflatingERC20.json"));
class DeflatingERC20 extends eth_wallet_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, DeflatingERC20_json_1.default.abi, DeflatingERC20_json_1.default.bytecode);
        this.assign();
    }
    deploy(totalSupply) {
        return this.__deploy([eth_wallet_1.Utils.toString(totalSupply)]);
    }
