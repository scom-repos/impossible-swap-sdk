...
exports.ImpossibleERC20 = void 0;
const eth_wallet_1 = require("@ijstech/eth-wallet");
const ImpossibleERC20_json_1 = __importDefault(require("./ImpossibleERC20.json"));
class ImpossibleERC20 extends eth_wallet_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, ImpossibleERC20_json_1.default.abi, ImpossibleERC20_json_1.default.bytecode);
        this.assign();
    }
    deploy() {
